...
export async function processJob(job: EnrichmentJob): Promise<void> {
  ...
  try {
    ...
    log({
      ...
      serper_calls: timings.serper.calls,
      serper_search: timings.serper.search,
      serper_maps: timings.serper.maps,
      serper_errors: timings.serper.errors,
      serper_domain: timings.serper.domain,
      serper_gmb: timings.serper.gmb,
      serper_instagram: timings.serper.instagram,
      serper_stages: timings.serper.by_stage,
