...
/** Reclaim `running` jobs whose worker died mid-crawl. Long enough that a slow job is not billed twice. */
export const ENRICH_STALE_RUNNING_SECONDS = 900;
/** Hard cap for bulk qualify (lista / importar e qualificar). */
export const QUALIFY_LIST_MAX = 50;
