...
export const TAXONOMY: NicheSeedNode[] = [
  {
    ...
    segments: [
      { slug: "clinicas-estetica", nome: "Clínicas de estética", keywords: ["clinicas de estetica", "estetica e outros servicos de cuidados com a beleza"], exclusoes: [], name_stems: ["ESTETICA", "DERMA"], ordem: 1 },
  ...
  },
  {
    ...
    segments: [
      ...
      { slug: "hotelaria-animal", nome: "Hotelaria animal", keywords: ["alojamento de animais", "alojamento, higiene e embelezamento de animais"], exclusoes: [], name_stems: ["PET HOTEL", "HOSPET"], ordem: 4 },
      { slug: "adestramento", nome: "Adestramento", keywords: ["adestramento", "atividades veterinarias"], exclusoes: [], name_stems: ["ADESTRA", "CANINO"], ordem: 5 },
  ...
  },
  {
    ...
    keywords: ["lavanderias", "tinturarias", "toalheiros"],
    exclusoes: [], name_stems: ["SERVICO", "LOCAL"], ordem: 11,
    segments: [
      { slug: "lavanderias", nome: "Lavanderias", keywords: ["lavanderias", "tinturarias", "toalheiros"], exclusoes: [], name_stems: ["LAVANDER", "LAVA"], ordem: 1 },
    ],
  },
  {
  ...
  },
  {
    ...
    segments: [
      ...
      { slug: "impermeabilizacao-vazamentos", nome: "Impermeabilização e vazamentos", keywords: ["impermeabilizacao em obras de engenharia civil", "instalacoes hidraulicas, sanitarias e de gas"], exclusoes: [], name_stems: ["IMPERM", "VAZA"], ordem: 12 },
      { slug: "pintura-predial", nome: "Pintura predial", keywords: ["pintura de edificios"], exclusoes: [], name_stems: ["PINTURA", "PREDIO"], ordem: 13 },
      ...
      { slug: "climatizacao", nome: "Climatização e ar-condicionado", keywords: ["instalacao e manutencao de sistemas centrais de ar condicionado", "ventilacao e refrigeracao"], exclusoes: [], name_stems: ["CLIMA", "ARCOND"], ordem: 15 },
  ...
  },
  {
    ...
    segments: [
      ...
      { slug: "isolamento-termico", nome: "Isolamento térmico e acústico", keywords: ["tratamentos termicos, acusticos"], exclusoes: [], name_stems: ["ISOLAM", "ACUST"], ordem: 21 },
      { slug: "epis-obra", nome: "EPIs e segurança para obra", keywords: ["equipamentos e acessorios para seguranca pessoal e profissional", "roupas de protecao e seguranca", "roupas e acessorios para uso profissional e de seguranca do trabalho"], exclusoes: [], name_stems: ["EPI", "SEGUR"], ordem: 22 },
    ],
  },
  {
  ...
  },
  {
    ...
    keywords: ["agencias de publicidade", "consultoria em publicidade", "marketing direto"],
    exclusoes: [], name_stems: ["MKT", "ADS"], ordem: 15,
    segments: [
      { slug: "marketing-digital", nome: "Agências de marketing e performance", keywords: ["agencias de publicidade", "consultoria em publicidade", "marketing direto"], exclusoes: [], name_stems: ["PERF", "ADS"], ordem: 1 },
    ],
  },
  {
  ...
  },
  {
    ...
    segments: [
      ...
      { slug: "cambio", nome: "Câmbio", keywords: ["corretoras de cambio", "bancos de cambio"], exclusoes: [], name_stems: ["CAMBIO", "FX"], ordem: 7 },
