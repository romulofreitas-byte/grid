...
-- Apply supabase/migrations/20260824000000_establishments_search.sql if missing, then populate:
--   psql $DATABASE_URL -f scripts/db/populate-establishments-search.sql
